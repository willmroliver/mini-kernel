...
static const char *FDT_NODE_MEMORY = "memory";
static const char *FDT_NODE_CPUS = "cpus";
 ...
 */
void dt_traverse(struct fdt_node *node, int (*cb)(struct fdt_node *node, void *arg), void *arg);
